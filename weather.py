...
api_key = '83dad3ab9462b758d7aca6622e4100a4'
...
with open('weather.txt','w') as f:
	f.write("-------------------------------------------------------------\n")
	f.write("Weather Status for: " + location.upper() + "\t" + date_time + "\n")
	f.write("-------------------------------------------------------------\n")
	f.write("Current Temprature is: " + " deg C\n")
	f.write("Current Weather Description: " + weather_desc + "\n")
